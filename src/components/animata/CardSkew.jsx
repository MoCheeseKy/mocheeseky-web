...
export default function CardSkew({ className, children }) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'flex w-fit transform-gpu flex-col gap-4 rounded-3xl border border-border bg-zinc-700 text-zinc-200 shadow-lg transition-transform ease-linear will-change-transform',
        className
      )}
      style={{
